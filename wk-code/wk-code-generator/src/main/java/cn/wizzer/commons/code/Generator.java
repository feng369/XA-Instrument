...
public class Generator {
    ...
    public static void main(String[] args) throws Exception {
        ...
        options.addOption("sev",
                "package",
                true,
                "models base package name,default:services/${package}");
        options.addOption("v",
                "views",
                true,
        ...
        for (Map.Entry<String, TableDescriptor> entry : tables.entrySet()) {
            ...
            typeMap.put("models", servicePackageName);
            typeMap.put("serviceImpl", servicePackageName);
            typeMap.put("controller", controllerPackageName);

            for (String type : new String[]{"model", "models", "serviceImpl", "controller", "view", "locale"}) {
    ...
    private static void usage(Options options) {
        ...
        formatter.printHelp("Main [options] [all|entity|models|controller|view]", options);
        System.exit(1);
    }
