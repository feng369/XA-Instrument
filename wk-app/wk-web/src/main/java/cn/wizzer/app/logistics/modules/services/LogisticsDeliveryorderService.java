...
public interface LogisticsDeliveryorderService extends BaseService<logistics_Deliveryorder>{
    ...
    List<Record> getDeliveryOrderList(String personid, String pstatus, String deliveryordernum,Integer pagenumber,Integer pagesize);

    void addDelDo(String orderid, String personid,String curPosition);
