...
public class LogisticsOrderController{
    ...
    @Ok("json")
    @RequiresPermissions("platform.logistics.order")
    public Object data(@Param("otype") String otype,@Param("selectForm") String selectForm,@Param("length") int length, @Param("start") int start, @Param("draw") int draw, @Param("::order") List<DataTableOrder> order, @Param("::columns") List<DataTableColumn> columns,@Param("pstatus") String pstatus) {
		Cnd cnd = Cnd.NEW();
