...
public class SysRegistauditServiceImpl extends BaseServiceImpl<Sys_registaudit> implements SysRegistauditService {
    ...
    public NutMap getRegistList(int result,int length, int start, int draw, List<DataTableOrder> orders, List<DataTableColumn> columns, Cnd cnd) {
        ...
        String sqlStr = " SELECT " +
                ...
                "WHERE st.unitid = '" + Globals.unitid + "' AND sr.result =" + result;
