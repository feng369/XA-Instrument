...
module.exports = function(Chart) {
	...
	Chart.Animation = Chart.Element.extend({
		...
		render: null, // render function used by the animation models
...
module.exports = function(Chart) {
	...
	// The layout models is very self explanatory.  It's responsible for the layout within a chart.
	// Scales, Legends and Plugins all rely on the layout models and can easily register to be placed anywhere they need
	// It is this models's responsibility of carrying out that layout.
	Chart.layoutService = {
		defaults: {},
